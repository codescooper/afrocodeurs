...
export function ChatRoom({ conversationId, currentUserId, initialMessages, compact = false }: {
  ...
  return <div className={cn("flex flex-col", compact ? "h-[min(62dvh,32rem)]" : "min-h-[65dvh]")}>
    <div className="flex-1 space-y-3 overflow-y-auto p-4 sm:p-6">
      {messages.length === 0 && <p className="py-12 text-center text-sm text-muted-foreground">Aucun message. Commencez la conversation.</p>}
