...
**Rendre la prod pleinement fonctionnelle** : (1) brancher **Resend** (clé + domaine vérifié) et **Turnstile** (clés) dans les variables Railway → email + CAPTCHA actifs ; (2) ajouter du **contenu fondateur** (le site est vide — cold-start). Puis rétention Tier 2 (follow, save, digest hebdo, PWA installable).
