...
export const config = {
  matcher: [
    "/((?!api|_next/static|_next/image|favicon.ico|icon.svg|manifest.webmanifest|robots.txt|sitemap.xml|sw.js|pow-worker.js|ancestral-pixel-loop.mp3|whatsapp-community-qr.png).*)",
  ],
};
